  ...
  ?>
    <div class="main-table">
        ...
        <div class="tittle-autobook">
            <h2>Auto-reserva </h2><button id="addautobook" >Añadir</button>
        </div>
        <div class="sub-table">
            <div class="sub-table-scroll">
                <table class="users">
                    ...
                    <tr id="addnewautobook" style="display: none;">
                        ...
                        <th>
                            <button name="Guardar" value="save" id="savenewautobook">Guardar</button>
                        </th>
                        <th>
                            <button name="Cancelar" value="cancel" id="cancelnewautobook">Cancelar</button>
                        </th>
                    </tr>
                    <?php
        require_once "includes/dbh.inc.php";
        ...
        foreach ($autobooks as &$autobook) {
          echo '<tr><th>'.$autobook["weekday"].'</th><th>'.$autobook["email"].'</th><th>'.$autobook["start"].'</th><th>'.$autobook["end"].'</th><th>'.$autobook["book"].'</th><th>'.$autobook["class"].'</th><th>'.$autobook["grade"].'</th><th><button name="delete" value="deleteautobook">Eliminar</button></th></tr>';
        }
        ?>
                </table>
            </div>
        ...
        echo '<input class="checkbox" type="checkbox" value="autoBook" '.$checked.'>';
        ?>
            </div>
        </div>
        ...
        $('button').click(e => {
            ...
            } else if (e.target.value == "deleteautobook") {
                console.log();
              $weekday = document.getElementById("weekday");
              $email =  document.getElementById("email-select");
              $start =  document.getElementById("start-select").value;
